...
void si446x_set_property1( U8 GROUP, U8 NUM_PROPS, U8 START_PROP, ... )
{
    va_list argList;
    U8 cmdIndex;
    U8 xx[]={0x12,0x02,0x11};
    Pro2Cmd[0] = SI446X_CMD_ID_SET_PROPERTY;
    Pro2Cmd[1] = GROUP;
    Pro2Cmd[2] = NUM_PROPS;
    Pro2Cmd[3] = START_PROP;
    ...
    // if(strncmp(&Pro2Cmd[1],xx,3)==0)
    // {
    //     printf("change the field2 length\n");
    // }
    // else
    // {
    //     printf("not change the field2\n");
    // }
